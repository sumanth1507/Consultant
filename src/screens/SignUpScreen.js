...
//         }
//         console.log(data.email,data.password,value1,address,date,data.name);
//     }
...
//                             withShadow
//                             autoFocus
//                             textInputStyle={{ height: 38, marginTop: 9 }}
...
//                             style={{ marginTop: 2, backgroundColor: '#009387', marginLeft: 10, height: 40, width: 170, alignItems: "center", justifyContent: "center", borderRadius: 15 }}
...
//                             color={"#009387"}
//                         />
//                         <Text style={{ color: '#000000', fontSize: 17, marginTop: 3 }}>You Agree to our <Text onPress={()=>{ Linking.openURL('https://www.docsapp.in/health/termsandprivacy')}} style={{ fontWeight: "bold", fontSize: 17 }}>Terms and Conditions</Text></Text>
//                     </View>
